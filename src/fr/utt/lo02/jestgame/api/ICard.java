...
/**
 * @author Edouard Cette classe est l'interface permettant de manipuler les
 *         cartes du jeu de Jest.
 */
public interface ICard {

	/**
	 * @param players Tous les joueurs de la partie.
	 * @return Renvoie le joueur qui est choisit par la carte pour la recevoir comme
	 *         trophé.
	 */
	 ...
	 * @return Renvoie la valeur de bonus de fin de la partie, par exemple la valeur
	 *         bonus pour les paires noir ou pour le Joker sans coeurs.
	 */
